...
//		expectedResult.add("invalid merchant");
//
//		when(smsService.sendSms(smsRequest)).thenReturn(expectedResult);
//
//		mockMvc.perform(MockMvcRequestBuilders.post("/message/sms").content(objectMapper.writeValueAsString(smsRequest))
//				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
